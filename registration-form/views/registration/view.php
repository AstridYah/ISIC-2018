...
/* @var $model app\models\Registration */
	...
	$s_concepto = 'Registration Fee ISICS 2018'; // Concepto del servicio
...
<div class="registration-view">
		...
		<div class="alert alert-warning">
			...
			<p><?= Html::encode($model->prefix) ?> <?= Html::encode($model->fullName) ?>, <br /> Thank you for registering for the ISICS 2018 taking place at Merida, Mexico from March 21-23, 2018.</p>
			...
			<p> If you have paid by PayPal, your ISICS Registration Confirmation will be sent via email in the next 24 hours. If you do not received it, please, contact the Registration Chair at admin@isics-symposium.org attaching a copy of your PayPal payment receipt.</p>
		</div>
		<?php endif; ?>
