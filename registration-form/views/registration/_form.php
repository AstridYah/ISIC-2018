...
$this->registerJs('
	...
	function calculateTotalPayment(){
		...
		var totalCost = registerType[0].cost + (banquet_ticket*banquet_ticket_cost);
...
<div class="registration-form">
	...
	<p style="margin-left:0.5cm"> <b> <?= Html::encode('Paper Author Registration:')?> </b> <?= Html::encode('Full conference access, coffee breaks, proceedings, conference banquet (please register before March 7th, 2018 so we can book your place), city guided-tour, participation certificate.')?> 
        <br>
        <b> <?= Html::encode('Poster Author Registration:')?> </b> <?= Html::encode('Full conference access, coffee breaks, proceedings, city guided-tour, and participation certificate. If you register for poster author, please purchase additional ticket for conference banquet if necessary when register.')?> 
        <br>
        <b> <?= Html::encode('Only Attendees Registration:')?> </b> <?= Html::encode('Full conference access, coffee breaks, city guided-tour, and participation certificate. If you register for only attendees, please purchase additional ticket for conference banquet if necessary when register.')?> 
	...
	<p class="student-proof-text"><span style="color: red">*</span> Student Registration and UADY/CIMAT/IIMAS/UPY Member Registration require a proof of status (letter of enrollment, employee/student ID).</p>    
	...
	<p>For each contribution, please list:<br/>
		1) The type of contribution (Paper, poster).<br/>
	...
	<p> <?= Html::encode('The registration fee will not be refunded to the authors if it is required to cover the publications expenses of accepted papers. Any cancellations after registration will incur $1,000 MXN administrative charges. No refunds will be made for cancellations after January 12, 2018. No refunds will be given for non-attendance. To requests for cancellations, substitutions, or other changes, please contact the admin@isics-symposium.org.')?> </p>
